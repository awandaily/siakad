   ...
   <section>
        ...
        <aside id="leftsidebar" class="sidebar">
          ...
          <!--   <img src="<?php echo base_url().$poto;?>"  style="z-index:-230px;position:absolute;height:135px;width:300px;margin-left:-15px;margin-top:-13px" alt="User"  />   -->
                ...
                <div class="info-container">
                    ...
                    <div class="email font-bold">NIP. <?php echo isset($dp->nip_asli)?($dp->nip_asli):"";?></div>
	...
	function lesmenu()
	{
		 ...
		 $("#pull-screen").hide();
					   ...
					   <div align="center" style="margin-top:-40px" class="hide pull-right col-white font-bold"> Suara Effect
                                <div class="switch"  >
...
<!------------------------------------------------------------------------->
 ...
 ?>
	...
	<a  class="menuclick" href="<?php echo base_url()?>guru_instal/profile" >
	...
	<a  class="menuclick" href="<?php echo base_url()?>guru_instal/index" >
	...
	<a  class="menuclick" href="<?php echo base_url()?>guru_instal/tahap2" >
...
<!--	<li class='pil2 sound <?php echo $tahap3 ?> border-line'>
	<a  class="menuclick" href="<?php echo base_url()?>guru_instal/tahap3" >
	...
	<a  class="menuclick" href="<?php echo base_url()?>guru_instal/tahap4" >
	<i class="material-icons">filter_3</i>
	<span>JADWAL</span>
	<!--<span class="label label-primary label-circle pull-right">23</span>-->
	</a>
