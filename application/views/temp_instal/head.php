...
<head>
   ...
   <title><?php echo $this->m_reff->tm_pengaturan(7)?></title>
  
    <link rel="icon" href="<?php echo base_url()?>/file_upload/img/<?php echo $this->m_reff->tm_pengaturan(10)?>" type="image/x-icon">
<!--
 ...
 -->
    ...
    <link href="<?php echo base_url()?>new/plugins/bootstrap-material-datetimepicker/css/bootstrap-material-datetimepicker.css" rel="stylesheet" />

    <!-- Wait Me Css -->
    <link href="<?php echo base_url()?>new/plugins/waitme/waitMe.css" rel="stylesheet" />
	...
	<link rel="stylesheet" type="text/css" href="<?php echo base_url()?>plug/boostrap/css/compiled/theme_styles_user.css"/>
	...
	<script src="<?php echo base_url()?>new/js/angular.js"></script>
 	...
 	<script src="<?php echo base_url()?>plug/js/materi.js"></script>
...
<script type="text/javascript" src="<?php echo base_url()?>plug/datatables/datatable.js"></script>
        ...
        <link href="<?php echo base_url();?>plug/slider/css/lightgallery.css" rel="stylesheet">
  		 
        <script src="<?php echo base_url();?>plug/slider/js/lightgallery-all.min.js"></script>
