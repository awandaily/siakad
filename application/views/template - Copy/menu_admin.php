 <nav class="horizontalMenu clearfix">
     <ul class="horizontalMenu-list">
         ...
         <li aria-haspopup="true"><a href="#" class="sub-icon"><i class="fe fe-bar-chart-2"></i> Charts <span class="badge badge-danger horizontal-badge">5</span><i class="fe fe-chevron-down horizontal-icon"></i></a>
             <ul class="sub-menu">
         ...
         <li aria-haspopup="true"><a href="#" class="sub-icon"><i class="fe fe-layers"></i> Elements<i class="fe fe-chevron-down horizontal-icon"></i></a>
                     ...
                     <div class="mega-menubg hor-mega-menu">
                         <div class="row">
                             ...
                             <div class="col-lg-3 col-md-12 col-xs-12 link-list">
                                 <ul>
                                     <li>
                                         <h3 class="fs-14 font-weight-bold mb-1 mt-2">Icons <span class="badge badge-success ">New</span></h3>
                                     </li>
         ...
         <li aria-haspopup="true"><a href="#" class="sub-icon"><i class="fe fe-package "></i> Advanced UI <i class="fe fe-chevron-down horizontal-icon"></i></a>
             <ul class="sub-menu">
         ...
         <li aria-haspopup="true"><a href="#" class="sub-icon"><i class="fe fe-codepen"></i> Utilities <i class="fe fe-chevron-down horizontal-icon"></i></a>
             <ul class="sub-menu">
         ...
         <li aria-haspopup="true"><a href="#" class="sub-icon"><i class="fe fe-shopping-cart"></i> E-Commerce <span class="badge badge-warning horizontal-badge">hot</span><i class="fe fe-chevron-down horizontal-icon"></i></a>
             <ul class="sub-menu">
         ...
         <li aria-haspopup="true"><a href="#" class="sub-icon"><i class="fe fe-aperture"></i> Custom <i class="fe fe-chevron-down horizontal-icon"></i></a>
             <ul class="sub-menu">
