  	...
  	<div class="col-md-12">
  		...
  		<div class="col-md-6">
  			...
  			<div class="input-group">
  				...
  				<div class="form-line">
  					<input class="form-control" placeholder="Gelar depan" value="<?php echo substr($pass, 0, -2); ?>" name="password" type="password" onchange="akun()">
  				</div>
  			</div>
  		</div>
  	</div>
  	...
  	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 card" id="area_modal_edit">
  		...
  		<div class="col-md-12">
  			...
  			<div class="col-md-4">
  				<div class="form-group form-float">
  					...
  					<?php
						$dataray = array();
						$dataray[] = "=== Pilih ===";
						$db = $this->db->get("tr_agama")->result();
						foreach ($db as $db) {
							$dataray[$db->id] = $db->nama;
						}
						echo form_dropdown("f[id_agama]", $dataray, $data->id_agama, 'class="selectpicker col-md-12 show-tick"  ');
						?>
  				</div>
  			</div>
  			...
  			<div class="col-md-12" style="z-index:8">
  				<center>
  					<button onclick="submitFormNoResset('modal_edit')" class="btn-block pull-right btn bg-teal"><i class="material-icons">save</i> SIMPAN</button>
  				</center>
  			</div>
