...
<div class="row clearfix">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="card">
            <div class="header">
                ...
                <h2 class="sound">DATA AKTIVITAS GURU</h2>
            ...
            <div class="body">
                <div class="row clearfix">
                    ...
                    <div class="col-sm-4 col-black">
                        <select class="form-control show-tick" id="id_sts<?php echo $token;?>" data-live-search="true">
                            <option value="">=== PILIH STATUS PEGAWAI ===</option>

                            <?php 
								   //$db=$this->db->get("tr_tingkat")->result();
                            		$this->db->order_by("nama", "ASC");
                            		$qsts = $this->db->get("tr_sts_pegawai")->result();
								   	foreach($qsts as $val){
										echo "<option value='".$val->id."'>".$val->nama."</option>";
								   	}
							?>
                    ...
                    <div class="col-sm-4 col-black">
                        <select class="form-control show-tick" id="id_jabatan<?php echo $token;?>" data-live-search="true">
                            <option value="">=== PILIH JABATAN ===</option>

                            <?php 
								   //$db=$this->db->get("tr_tingkat")->result();
                            		$this->db->order_by("nama", "ASC");
                            		$qjabatan = $this->db->get("tr_jabatan")->result();
								   	foreach($qjabatan as $val){
										echo "<option value='".$val->id."'>".$val->nama."</option>";
								   	}
							?>
   ...
   var  dataTable = $('#tabel').DataTable({ 
	   ...
	   scrollY: 470,
        ...
        "ajax": {
            "url": "<?php echo site_url('aktivitas_guru/data');?>",
            "type": "POST",
			"data": function ( data ) {
						
				  data.id_guru = $('#id_guru<?php echo $token;?>').val();
				  data.id_sts = $('#id_sts<?php echo $token;?>').val();
				  data.id_jabatan = $('#id_jabatan<?php echo $token;?>').val();
