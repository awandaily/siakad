...
{    $nama=$dt->nama;
    ...
    //    }
        ...
        $class="cursor col-indigo font-bold";
        
    $nama="<span onclick='showing(`$dt->id`,`$idtugas`,`$dt->nama`)' class='$class'> $dt->nama</span>";    
...
function showing1(idsiswa,idtugas,nama)
{
     $.post("<?php echo site_url("kirim_tugas/getTugas"); ?>",{idtugas:idtugas,idsiswa:idsiswa},function(data){
		...
		//	    $("#ketugas").html(data[1]);
			    ...
			    var isi="<div style='padding:20px'><b>Keterangang/Penjelasan:</b><br>"+isip+"</div><br>"+file;
