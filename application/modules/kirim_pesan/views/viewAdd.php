							 ...
							 <div class="row clearfix">
                                ...
                                <input name="f[metode_pengerjaan]"  value="0" id="radio_31" class="with-gap radio-col-teal" checked type="radio">
                                <label for="radio_31">TUGAS DI UPLOAD KE APLIKASI</label>
                                
                                 <input  name="f[metode_pengerjaan]" value="1" id="radio_30" class="with-gap radio-col-teal"    type="radio">
