...
<div class="col-md-12">&nbsp;</div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="header">
                            <h2>DATA REFERENSI TEMPAT PKL</h2>
  ...
  <script type="text/javascript">
  	  function hapus(id,akun){
		   ...
		   $.post("<?php echo site_url("referensi/hapus/tr_mitra"); ?>",{id:id},function(){
			   reload_table();
		      })
		   })
	  };
   ...
   // $(document).ready(function() {
      table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('referensi/data/tr_mitra');?>",
            "type": "POST",
...
function add()
{
	...
	$("form").attr('url',"<?php echo base_url()?>referensi/insert/tr_mitra");
								...
								<div class="form-group form-float">
                                    <div class="form-line focused success">
                                        ...
                                        <label class="form-label" style="margin-top:-5px">Nama</label>
									 	...
									 	<div class="form-group form-float">
                                    <div class="form-line focused success">
                                        <input type="text" class="form-control" name="f[lokasi]"   required>
                                        <label class="form-label" style="margin-top:-5px">LOKASI</label>
                                    </div>
                                </div>
...
$("#imgInp").change(function() {
 ...
 function edit(id,nama,alias,lokasi)
	 {	 
		 			
			 	$("[name='id']").val(id);
			 	$("[name='id_']").val(id);
			 	$("[name='f[nama]']").val(nama);
			 	$("[name='f[lokasi]']").val(lokasi);
				$("#modal_artikel").modal({backdrop: 'static',drugged:true, keyboard: false});
				$("form").attr('url',"<?php echo base_url()?>referensi/update/tr_mitra");
	 }
