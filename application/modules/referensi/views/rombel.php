 ...
 <script type="text/javascript">
     function upd_sts(id) {
         ...
         $.post("<?php echo site_url("referensi/update_status_kelas"); ?>", {
             id: id,
             mode: mode
         }, function() {
     ...
     function hapus(id, akun) {
         alertify.confirm("<center>Hapus  <br> <span class='font-bold col-pink'>`" + akun + "`</span> <br> ?</center>", function() {
             $.post("<?php echo site_url("referensi/hapus_kelas"); ?>", {
                 id: id
             }, function() {
                 reload_table();
             })
 ...
 <script>
     ...
     function edit(id, tk, jur, rom, wali) {
         ...
         $.post("<?php echo site_url("referensi/editRombel"); ?>", {
             id: id,
             id_tk: tk,
             id_jurusan: jur,
             nama: rom,
                 ...
                 <div class="modal-body">
                     ...
                     <script>
                         function pilmapel() {
                             ...
                             $.post("<?php echo site_url("referensi/getMapel"); ?>", {
                                 idk: idk
                             }, function(data) {
