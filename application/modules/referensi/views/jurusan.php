...
<div class="col-md-12">&nbsp;</div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="header">
                            <h2>DATA REFERNSI KATEGORY JABATAN</h2>
                            ...
                            <div class="table-responsive">
                               <table id='table' class="tabel black table-bordered  table-hover dataTable" style="font-size:12px;width:100%">
								<thead  class='sadow bg-blue'>			
									...
									<th class='thead' >Nama Singkat </th>
									<th class='thead' >Nama Jurusan</th>
									
					            	 <th class='thead' >Mode KBM Realtime</th>
  ...
  <script type="text/javascript">
  	  function hapus(id,akun){
		   ...
		   $.post("<?php echo site_url("referensi/hapus/tr_jurusan"); ?>",{id:id},function(){
			   reload_table();
		      })
		   })
	  };
   ...
   // $(document).ready(function() {
      table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('referensi/data/tr_jurusan');?>",
            "type": "POST",
...
function cekKbm(id)
{
    ...
    var mode = document.getElementById("idkbm"+id).checked;
    $.post("<?php echo site_url("referensi/setModeKbm"); ?>",{id:id,mode:mode},function(){
...
function add()
{
	...
	$("form").attr('url',"<?php echo base_url()?>referensi/insert/tr_jurusan");
                    ...
                    <div class="modal-content"> <span  title="tutup"  data-dismiss="modal" class="    pull-right waves-effect"><i class="material-icons">cancel</i> </span>
                        ...
                        <div class="modal-body">
                         ...
                         <input type="hidden" readonly name="id_" >
								...
								<div class="form-group form-float">
                                    <div class="form-line focused success">
                                        <input type="text" class="form-control" name="f[alias]"   required>
...
$("#imgInp").change(function() {
 ...
 function edit(id,nama,alias)
	 {	 
		 			
			 	$("[name='id']").val(id);
			 	$("[name='id_']").val(id);
			 	$("[name='f[nama]']").val(nama);
			 	$("[name='f[alias]']").val(alias);
				$("#modal_artikel").modal({backdrop: 'static',drugged:true, keyboard: false});
				$("form").attr('url',"<?php echo base_url()?>referensi/update/tr_jurusan");
	 }
