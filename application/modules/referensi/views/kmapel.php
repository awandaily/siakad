...
<div class="col-md-12">&nbsp;</div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="header">
                            <h2>DATA REFERNSI KATEGORY MAPEL</h2>
  ...
  <script type="text/javascript">
  	  function hapus(id,akun){
		   ...
		   $.post("<?php echo site_url("referensi/hapus/tr_kategory_mapel"); ?>",{id:id},function(){
			   reload_table();
		      })
		   })
	  };
   ...
   // $(document).ready(function() {
      table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('referensi/data/tr_kategory_mapel');?>",
            "type": "POST",
...
function add()
{
	...
	$("form").attr('url',"<?php echo base_url()?>referensi/insert/tr_kategory_mapel");
                    ...
                    <div class="modal-content"> <span  title="tutup"  data-dismiss="modal" class="    pull-right waves-effect"><i class="material-icons">cancel</i> </span>
                        ...
                        <div class="modal-body">
                         ...
                         <input type="hidden" readonly name="id_" >
								...
								<div class="form-group form-float"> <label class="form-label">Kode</label>
								...
								<div class="form-group form-float"> <label class="form-label">Nama</label>
                                    <div class="form-line focused success">
...
$("#imgInp").change(function() {
 ...
 function edit(id,nama,kode)
	 {	 
				...
				$("#modal_artikel").modal({backdrop: 'static',drugged:true, keyboard: false});
				$("form").attr('url',"<?php echo base_url()?>referensi/update/tr_kategory_mapel");
	 }
