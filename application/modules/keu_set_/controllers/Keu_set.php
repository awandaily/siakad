...
class Keu_set extends CI_Controller
{
	...
	function getTagihan()
	{
		...
		foreach ($list as $dataDB) {
			...
			$tombol = '<div class="demo-button-groups">
                                <div class="btn-group" role="group">
              <button type="button" onclick="edit(`' . $dataDB->id . '`,`' . $dataDB->id_tk . '`,`' . $dataDB->id_jurusan . '`,`' . $dataDB->id . '`,`' . $dataDB->id . '` )" 
              class="btn bg-teal waves-effect waves-light" title="edit"><i class="material-icons">border_color</i></button>
              <button type="button" onclick="hapus(`' . $dataDB->id . '`,`' . $dataDB->nama_biaya . '`)" title="hapus" class="btn bg-blue-grey waves-effect waves-light"><i class="material-icons">delete_sweep</i></button>
              <button class="hide" type="button" onclick="genre(`' . $dataDB->id . '`,`' . $dataDB->nama_biaya . '`)" title="Generate" class="btn bg-pink waves-effect waves-light"><i class="material-icons">mouse</i></button>
