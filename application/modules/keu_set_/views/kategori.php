                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="header">
                            <h2>DATA REFERENSI KATEGORY PENGELUARAN</h2>
  ...
  <script type="text/javascript">
  	  function hapus(id,akun){
		   ...
		   $.post("<?php echo site_url("keu_set/hapus/keu_tr_kategori_pengeluaran"); ?>",{id:id},function(){
			   reload_table();
		      })
		   })
	  };
   ...
   // $(document).ready(function() {
      table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('keu_set/data/keu_tr_kategori_pengeluaran');?>",
            "type": "POST",
...
function add()
{
	...
	$("form").attr('url',"<?php echo base_url()?>keu_set/insert/keu_tr_kategori_pengeluaran");
...
$("#imgInp").change(function() {
 ...
 function edit(id,nama,kode)
	 {	 
				...
				$("#modal_artikel").modal({backdrop: 'static',drugged:true, keyboard: false});
				$("form").attr('url',"<?php echo base_url()?>keu_set/update/keu_tr_kategori_pengeluaran");
	 }
