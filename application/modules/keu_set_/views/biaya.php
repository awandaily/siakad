                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				 ...
				 <div class="card" id="area_lod">
                        <div class="body">
						 ...
						 <p>   <button class="btn btn-block bg-indigo" onclick="generate()">GENERATE BIAYA</button>  </p>
  ...
  <script type="text/javascript">
  	  function hapus(id,akun){
		   alertify.confirm("<center>Hapus data ini tidak berarti menghapus data tagihan pada siswa <br>Hapus  <span class='font-bold col-pink'>`"+akun+"`</span> <br> ?</center>",function(){
	   ...
	   function genre(id,akun){
		   alertify.confirm("<center>generate Biaya :<br> <span class='font-bold col-pink'>`"+akun+"`</span> <br> ?</center>",function(){
		   $.post("<?php echo site_url("welcome/generate_all"); ?>",{id:id},function(){
			   reload_table();
		      })
		   })
	  };
