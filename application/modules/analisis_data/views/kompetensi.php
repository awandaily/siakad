...
<div class="breadcrumb-header justify-content-between">
	<div class="dropdown">
		<button aria-expanded="false" aria-haspopup="true" class="btn ripple btn-primary" data-toggle="dropdown" id="dropdownMenuButton" type="button">Pilih Aksi<i class="fas fa-caret-down ml-1"></i></button>
		<div class="dropdown-menu tx-13">
			<a class="dropdown-item" data-toggle="modal" data-target="#md-mutasi" href="#">Download Mutasi Siswa</a>
...
<a href="#" class="pull-right btn bg-teal waves-effect" style="padding-bottom:10px;margin-right:20px;margin-top:-10px;color:white;" data-toggle="modal" data-target="#md-mutasi">
	DOWNLOAD MUTASI SISWA></a>
<br>
			...
			<div class="entry2 ">
				...
				<div class="table-responsive">
					...
					<table class="table table-bordered mg-b-0 text-md-nowrap">
						...
						<tr class="bg-teal sadow tx-black">

							<td rowspan="2"><b>NO</b></td>
							<td rowspan="2"><b>KOMPETENSI</b></td>
							<td rowspan="2"><b>JENIS KELAMIN</b></td>

							<td colspan="<?php echo $max; ?>" align="center">

								<b>KELAS</b>
							</td>
							<td rowspan="2"><b>JUMLAH TOTAL</b></td>
						...
						?>
							...
							<tr>
								...
								<td> <?php echo $jmlL;
										$jumlahCowok = $jmlL + $jumlahCowok; ?></td>
							</tr>
							...
							<tr>
								...
								<td> <?php echo $jmlP;
										$jumlahCewek = $jmlP + $jumlahCewek; ?></td>
							</tr>
							...
							<tr>
								...
								<td class='bg-lime'>
									<font color='black'><?php echo $jmlP + $jmlL;
														$jmlT = $jmlTotal + $jmlT; ?></font>
								</td>
						...
						?>
							...
							<tr>
								...
								<td colspan="<?php echo ($max + 3) ?>"> KELAS <?php echo $kelas_romawi; ?></td>
						...
						<tr class="bg-lime">
							...
							<td colspan="6"><b>
									<font color='black'>JUMLAH TOTAL SISWA </font>
								</b></font>
							</td>
							<td><b>
									<font color='black'><?php echo $this->mdl->jmlSiswaGroup("", "", ""); ?></font>
								</b></td>
				...
				<div class="table-responsive">
					...
					<table class="table table-bordered mg-b-0 text-md-nowrap">
						...
						<tr class="bg-teal tx-black">

							<td rowspan="2"><b>NO</b></td>
							<td rowspan="2"><b>KELAS</b></td>
							<td colspan="2"><b>JENIS KELAMIN</b></td>
							<td rowspan="2"><b>PINDAH/MUTASI</b></td>

							<td rowspan="2"><b>JML</b></td>
							<td rowspan="2"><b>KET</b></td>
						</tr>

						</tr>

						<tr class="bg-teal tx-black tx-normal">
