               ...
               <div class="breadcrumb-header justify-content-between">
               	<div>
               		<h4 class="content-title mb-2">Hi, Ini Input Non-Muslim </h4>
               		<nav aria-label="breadcrumb">
               			<ol class="breadcrumb">
               				<li class="breadcrumb-item"><a href="#">Raport</a></li>
               				<li class="breadcrumb-item active" aria-current="page">Input Non-Muslim</li>
               			</ol>
               		</nav>
               	</div>
               ...
               <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
               	<div class="card">
               		<div class="header">
               			...
               			<h2 class="sound">DATA NILAI SISWA NON MUSLIM : MAPEL PENDIDIKAN AGAMA DAN BUDI PEKERTI</h2>
               			<?php
               					...
               					<div class="table-responsive">
               						<table id='tabel' class="tabel table-striped black table-bordered  table-hover dataTable" style="font-size:12px;width:100%">
               							<thead class='sadow bg-teal'>
               								...
               								<th class='thead'> KKM </th>
               								<th class='thead'> SIKAP </th>
               								<th class='thead'> PENGETAHUAN </th>
               								<th class='thead'> KETERAMPILAN </th>
               ...
               <script type="text/javascript">
               	var dataTable = $('#tabel').DataTable({
               		...
               		"language": {
               			...
               			"sZeroRecords": "SISWA TIDAK ADA YANG NON-MUSLIM",
               		...
               		"ajax": {
               			"url": "<?php echo site_url('raport/getDataSiswa_non'); ?>",
               			"type": "POST",
               			"data": function(data) {
               	...
               	function setNilai(valu, id_siswa) {

               		var jml = $("[name='" + valu + "_" + id_siswa + "']").val();
               		$.post("<?php echo site_url("raport/update_non"); ?>", {
               			jml: jml,
               			valu: valu,
               			id_siswa: id_siswa
               		}, function() {
