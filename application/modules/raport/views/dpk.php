                               ...
                               <div class="breadcrumb-header justify-content-between">
                               	<div>
                               		<h4 class="content-title mb-2">Hi, Ini Raport Deskripsi Per Karakter </h4>
                               		<nav aria-label="breadcrumb">
                               			<ol class="breadcrumb">
                               				<li class="breadcrumb-item"><a href="#">Raport</a></li>
                               				<li class="breadcrumb-item active" aria-current="page">Deskripsi Per Karakter</li>
                               			</ol>
                               		</nav>
                               	</div>
						 	 ...
						 	 Isi Secara Otomatis
                               					...
                               					<div class="table-responsive">
                               						<table id='tabel' class="tabel table-striped black table-bordered  table-hover dataTable" style="font-size:12px;width:100%">
                               							<thead class='sadow bg-teal'>
                               								...
                               								<th class='thead' style='min-width:255px'>Integritas</th>
                               								<th class='thead' style='min-width:255px'>Religius</th>
                               								<th class='thead' style='min-width:255px'>Nasionalis</th>
                               								<th class='thead' style='min-width:255px'>Mandiri</th>
                               								<th class='thead' style='min-width:255px'>Gotong-royong</th>
                               ...
                               <script type="text/javascript">
                               	function isi_otomatis() {
                               		...
                               		$.post("<?php echo site_url("raport/isi_dpk"); ?>", {
                               	...
                               	var dataTable = $('#tabel').DataTable({
                               		...
                               		"ajax": {
                               			"url": "<?php echo site_url('raport/getDataSiswa_dpk'); ?>",
                               			"type": "POST",
                               			"data": function(data) {
                               	...
                               	function contoh() {
                               		...
                               		$("#mdl_detail").modal();
                               		$("#isi_detail").html("<center><img src='<?php echo base_url() ?>plug/img/contoh_dpk.JPG' alt='mohon tunggu...'></center> ");
                               	...
                               	function setNilai(nama, id_siswa) {
                               		...
                               		var val = $("[name='" + nama + "_" + id_siswa + "']").val();

                               		$.post("<?php echo site_url("raport/update_dpk"); ?>", {
                               			val: val,
                               			faktor: nama,
                               			id_siswa: id_siswa
                               		}, function() {
