               ...
               <div class="breadcrumb-header justify-content-between">
                   <div>
                       <h4 class="content-title mb-2">Hi, Ini Profile SIswa </h4>
               ...
               <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                   <div class="card">
                       ...
                       <div class="body">
                           ...
                           <div class="row clearfix">
                               <div class="col-sm-4">
                                   <button class="btn bg-teal btn-block" data-toggle="modal" data-target="#mdl_fim">
                                   ...
                                   <div class="table-responsive">
                                       <table id='tabel' class="tabel table-striped black table-bordered  table-hover dataTable" style="font-size:12px;width:100%">
                                           <thead class='sadow bg-teal'>
                                               <th class='thead' style='max-width:50px'>NO</th>
                                               <th class='thead' style='min-width:105px'>DETAIL</th>
                                               <th class='thead' style='min-width:125px'>NAMA</th>
                                               <th class='thead'>SISA TAGIHAN</th>
               ...
               <div id="mdl_fim" class="modal fade" role="dialog">
                   <div class="modal-dialog" id="area_fim">
                       <div class="modal-content">
                           <form id="fim" action="javascript:submitForm('fim')" method="post" url="<?php echo base_url() ?>raport/import_siswa">
                               ...
                               <div class="modal-body">
                                   <div class="row">
                                       <div class="col-md-12">
                                           <a href="<?php echo base_url() ?>raport/format_siswa" class="btn-block aves-effect btn bg-blue">
                                               DOWNLOAD FORMAT TERLEBIH DAHULU
                                           </a>
                                       </div>
                                   </div>
                                   <hr>
                                   <div class="row">
                                       <div class="col-md-12">
                                           <label>Masukan File Excelnya : </label> <br>
                                           <input type="file" class="form-control" name="file">
                                       </div>
                                   </div>
                               </div>
                               <div class="modal-footer">
                                   <button class="btn-block aves-effect btn bg-teal" onclick="submitForm('fim')">
               ...
               <script type="text/javascript">
                   ...
                   function edit(id) {
                       ...
                       $.post("<?php echo site_url("raport/edit_data_siswa"); ?>", {
                           id: id
                       }, function(data) {
                           $("#edit_isi").html(data);
                       });
                   ...
                   function hapus(id, nis, judul = null) {
                       alertify.confirm("<center>Menghapus akan membersihkan data terkait siswa:<br> <span class='font-bold'>`" + judul + "`</span> <br>Yakin Hapus ? </center>", function() {
                           $.post("<?php echo site_url("raport/hapus_siswa"); ?>", {
                               id: id,
                               nis: nis
                           }, function() {
                   ...
                   function aktifasi(id, judul = null) {
                       ...
                       alertify.confirm("<center>  <span class='font-bold'>`" + juduls + "`</span> </center>", function() {
                           $.post("<?php echo site_url("raport/aktifasi_pendidik"); ?>", {
                               id: id,
                               sts: judul
                           }, function() {
                               notif("Data berhasil dihapus !!");
