                               ...
                               <div class="breadcrumb-header justify-content-between">
                               	<div>
                               		<h4 class="content-title mb-2">Hi, Ini Raport Catatan Akademik </h4>
                               		<nav aria-label="breadcrumb">
                               			<ol class="breadcrumb">
                               				<li class="breadcrumb-item"><a href="#">Raport</a></li>
                               				<li class="breadcrumb-item active" aria-current="page">Catatan Akademik</li>
                               			</ol>
                               		</nav>
                               	</div>
                               	...
                               	<div class="card">
                               		<div class="header">
                               			...
                               			<div class="col-md-6">
                               				...
                               				<h2 class="sound">Catatan Akademik</h2>
                               				<?php
                               ...
                               <script type="text/javascript">
                               	function contoh() {
                               		...
                               		$("#mdl_detail").modal();
                               		$("#isi_detail").html("<center><img src='<?php echo base_url() ?>plug/img/contoh_ctt.JPG' alt='mohon tunggu...'></center> ");

                               	}

                               	function isi_otomatis() {

                               		$.post("<?php echo site_url("raport/isi_catatan_akademik"); ?>", {
                               	...
                               	var dataTable = $('#tabel').DataTable({
                               		...
                               		"ajax": {
                               			"url": "<?php echo site_url('raport/getDataSiswa_catatan'); ?>",
                               			"type": "POST",
                               			"data": function(data) {
