  		...
  		<div class="col-md-4" data-placement="top">
  			...
  			<div class="input-group">
  				...
  				<div class="form-line">
  					...
  					<input readonly name='f[nis]' value="<?php echo $data->nis; ?>" onkeydown="return nomor(this, event);" class="  form-control" placeholder="Nomor NIS" type="text">
  				...
  				<div class="form-line">
  					...
  					<?php
						...
						foreach ($sts as $val) {
							...
							$ray[$val->nama] = ucwords(strtoupper($val->nama));
						}
