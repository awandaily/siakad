                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane animated flipInY   active" id="home_with_icon_title">
									...
									<center>	<p  class="col-black"><b><?php echo $data->nama;?></b></p>
										<img  alt="<?php echo $data->nama;?>" class="img-responsive thumbnail" width="100%" style="max-height:190px" src="<?php echo base_url()?>file_upload/siswa/<?php echo str_replace("/","_",$data->tahun_masuk)?>/<?php echo $data->nis;?>/<?php echo $data->poto;?>">
  ...
  <td colspan="2"> <b>RIWAYAT PENDIDIKAN & DATA WALI   </b> </td>
                                ...
                                <div role="tabpanel" class="tab-pane animated flipInX" id="absensi">
									...
									//	{	$row=date("m");	}else{	$row=11;   } 
										...
										<td align='center'>".$this->mdl_absen->jmlMasuk($kode)."</td>
										<td align='center'>".$this->mdl_absen->jmlIzin($kode)."</td>
										<td align='center'>".$this->mdl_absen->jmlAlfa(substr($kode,0,4),substr($kode,5,2))."</td>
										</tr> ";
										} 
