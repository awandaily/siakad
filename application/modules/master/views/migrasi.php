                    ...
                    <div class="card" >
						...
						<h2 class="sound">MIGRASI DATA SISWA</h2>
						 ...
						 <div class="col-sm-4 col-black">
									...
									id="id_kelasf<?php echo $token;?>" name="kelas_lama"  data-live-search="true"  >
 ...
 $(".btnhapus").hide();
	...
	function pilcek(){
	 ...
	 function migrasikan()
	 {
		...
		$.post("<?php echo site_url("master/ajax_migrasi"); ?>",{id_kelas:kelas},function(data){
...
{ 
	$("#judul_mdl_detail").html("DATA DETAIL SISWA ");
				   $("#mdl_detail").modal( );
				   $.post("<?php echo site_url("master/detail_siswa"); ?>",{id:id},function(data){
...
function filter()
{
	  ...
	  <!-- Modal -->
<div class="modal fade" id="mdl_migrasi" tabindex="-1" role="dialog" 
