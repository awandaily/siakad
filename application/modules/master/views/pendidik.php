 ...
 <script type="text/javascript">
 	var dataTable = $('#tabel').DataTable({
 		...
 		"ajax": {
 			"url": "<?php echo site_url('master/data_pendidik'); ?>",
 			"type": "POST",
 			"data": function(data) {
