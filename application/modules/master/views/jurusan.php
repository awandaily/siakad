...
<div class="col-md-12">&nbsp;</div>
  ...
  <script type="text/javascript">
  	  function hapus(id,akun){
		   ...
		   $.post("<?php echo site_url("referensi/hapus/tr_jabatan"); ?>",{id:id},function(){
			   reload_table();
		      })
		   })
	  };
   ...
   // $(document).ready(function() {
      table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('referensi/data/tr_jabatan');?>",
            "type": "POST",
...
function add()
{
	...
	$("form").attr('url',"<?php echo base_url()?>referensi/insert/tr_jabatan");
 ...
 <div class="modal fade" id="modal_artikel" tabindex="-1" role="dialog">
	...
	<form  action="javascript:submitForm('modal_artikel')" id="f_modal_artikel" url="<?php echo base_url()?>profile/insert"   method="post" enctype="multipart/form-data">
                    <div class="modal-content"> <span  title="tutup"  data-dismiss="modal" class="    pull-right waves-effect"><i class="material-icons">cancel</i> </span>
                        <div class="modal-header">
                            <h4 class="modal-title col-indigo" id="defaultModalLabel">Data Master </h4>
...
$("#imgInp").change(function() {
 ...
 function edit(id,nama)
	 {	 
				...
				$("#modal_artikel").modal({backdrop: 'static',drugged:true, keyboard: false});
				$("form").attr('url',"<?php echo base_url()?>referensi/update/tr_jabatan");
	 }
