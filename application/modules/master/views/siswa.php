<?php $token=date("His");?>  
  <div class="row clearfix">
						 ...
						 <div class="col-sm-4 col-black">
                                ...
                                <div class="col-md-2">
                                	<select class="form-control show-tick" id="id_tkf"   data-live-search="true"  onchange='reload_table()'>
                                        ...
                                        <?php
                                        	foreach($db as $valt){
                                        		echo "<option value='".$valt->id."'>".$valt->nama."</option>";
                                        	}
                                        ?>
                                    </select>
                                </div>
                                <div class="col-md-4">
                                	<select class="form-control show-tick" id="id_jurusanf"   data-live-search="true"  onchange='reload_table()'>
                                        ...
                                        <?php
                                        	$dbj = $this->db->get("tr_jurusan")->result();
                                        	foreach($dbj as $vj){
                                        		echo "<option value='".$vj->id."'>".$vj->alias."</option>";
                                        	}
                                        ?>
                                    </select>
                                </div>
                            ...
                            <div class="table-responsive">
                             <table id='tabel' class="tabel table-striped black table-bordered  table-hover dataTable"  style="font-size:12px;width:100%" >
								<thead  class='sadow bg-teal' >			
									...
									<th class='thead' style='min-width:115px' >PROCESS</th>
   ...
   var  dataTable = $('#tabel').DataTable({ 
		...
		buttons: [
           // 'copy', 'csv', 'excel', 'pdf', 'print'
			 
			{
                ...
                text:'Download Data Siswa',	
            },
            {
				extend: 'excel',
                exportOptions: {
                    columns:[0,2,6,11,32,33]
                },
                text:'Download Akun Siswa',	
            },		
            /*
			{
				extend: 'pdf',
        ...
        "ajax": {
            "url": "<?php echo site_url('master/data_siswa');?>",
            "type": "POST",
			"data": function ( data ) {
						  ...
						  data.id_stsdata = $('#id_stsdata').val();
	...
	$("#judul_mdl_edit").html("EDIT DATA SISWA ");
				   $("#mdl_formSubmit_edit").modal( );
				    $("#formSubmit_edit").attr("url","<?php echo base_url("master/input_data_siswa");?>");
				 	    $.post("<?php echo site_url("master/edit_data_siswa"); ?>",{id:id},function(data){
						   						    $("#edit_isi").html(data);
													});
}
function detail(id)
{ 
  ...
  function hapus(id,nis,judul=null){
		   ...
		   $.post("<?php echo site_url("master/hapus_siswa"); ?>",{id:id},function(){
    ...
    <div class="modal-dialog" id="area_formSubmit">
        <div class="modal-content">
			...
			<form class="form-horizontal">
								...
								<div class="row clearfix">
                                    <div class="col-lg-4 col-md-4  form-control-label">
                                        <label for="email_address_2" class="col-black">STATUS SISWA</label>
                                    </div>
                                    <div class="col-lg-8 col-md-8  ">
                                        <div class="form-group">
                                            <div class="form-line">
                                        <?php
													 ...
													 echo form_dropdown("id_stsdata",$ray,"",'  id="id_stsdata"    class="form-control  col-md-12  " onchange="reload_table()" ');
													  ?>
                                            </div>
                                        </div>
                                    </div>
...
<div class="modal fade" id="mdl_formSubmitDown" tabindex="-1" role="dialog" 
    ...
    <div class="modal-dialog" id="area_formSubmitDown">
		...
		<form id="formSubmitDown" action="javascript:submitForm('formSubmitDown')" method="post"  >
            ...
            <div class="modal-body">
            <div class="col-md-12 body">    
       <center>				  <a class="sound" href="<?php echo base_url()?>master/download_format_siswa">Download Format  Upload</a> </center>		
    ...
    <div class="modal-dialog modal-lg" id="area_formSubmit_input">
        <div class="modal-content">
			...
			<div class="body">
							...
							<?php echo $this->load->view("form_input_siswa");?>
                        </div>
                    </div>
