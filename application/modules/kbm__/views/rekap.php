 <?php $token=date("His");?>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="header">
                         <div class="col-md-5 col-xs-12"  style="padding-bottom:15px">     <h2 style='font-size:16px'>Agenda KBM</h2> </div>
  ...
  <script type="text/javascript">
  	...
  	function edit(id){
  		...
  		$.post("<?php echo site_url("kbm/edit_rekap"); ?>",{id:id},function(data){
		    $("#form-edit").html(data);
		});
  	}
  	  ...
  	  function hapus(id,akun){
		   ...
		   $.post("<?php echo site_url("kbm/hapus_kbm"); ?>",{id:id},function(){
			   reload_table();
		      })
		   })
	  };
...
{
			$.post("<?php echo site_url("kbm/absen_siswa"); ?>",{id_kelas:id_kelas,id_jadwal:id,tgl:tgl,mapel:mapel},function(data){
