...
if($sumber==1){?>	 
  ...
  <div class="row clearfix" style="margin-top:-40px">
		...
		$datakikd=$ray;
		echo form_dropdown("kikd",$datakikd,$id_kikd,"class='form-control' style=' width:100%' onchange='insertMateriBaru()' ");?>
...
<div class="  clearfix "  > <span id="menu" >
 ...
 {
      $.post("<?php echo base_url()?>kbm",{ajax:"yes"},function(data){  
		           $(".content").html(data);
		      });
 }
       function sumber(id)
       { 
           ...
           if(id==1){
            ...
            alertify.confirm("<center>"+msg+"</center>",function(){
                loadkonten();
		   $.post("<?php echo base_url()?>kbm/addSumber",{id:id,idMapel:<?php echo $id_mapel;?>,idJadwal:<?php echo $id_jadwal;?>,idKelas:idkelas,jam:jam,izin:izin,jam_blok:jam_blok},function(data){ 
		      if(data=="finger")
		      {
...
{   loadkonten();
       ...
       $.ajax(
   {
      ...
      data: {id_jadwal:id_jadwal,id_kikd:id_kikd,idkelas:idkelas,idmapel:idmapel},
...
{	return false;	var loading="<img src='<?php echo base_url()?>plug/img/load.gif'> Mohon tunggu...";
