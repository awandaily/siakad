...
class Raport extends CI_Controller
{
	...
	function getDataSiswa_cetak()
	{
		...
		id=" . $dataDB->id . "&id_kelas=" . $id_kelas_1 . "&id_semester=1&id_tahun=" . $id_tahun_1 . "&id_tk=1' class='btn bg-light-green waves-effect '> 
		<i class='material-icons'>picture_as_pdf</i>   X - Ganjil</a>";
				...
				if ($cek) {
					$cetak .= " <a   target='_blank' href='" . base_url() . "raport/cetak_raport?
		id=" . $dataDB->id . "&id_kelas=" . $id_kelas_1 . "&id_semester=2&id_tahun=" . $id_tahun_1 . "&id_tk=1' class='btn bg-green waves-effect '> 
		<i class='material-icons'>picture_as_pdf</i>   X - Genap</a>";
				}
			}
			if ($id_kelas_2) {
				$cetak .= " <a   target='_blank' href='" . base_url() . "raport/cetak_raport?
		id=" . $dataDB->id . "&id_kelas=" . $id_kelas_2 . "&id_semester=1&id_tahun=" . $id_tahun_2 . "&id_tk=2' class='btn bg-light-blue waves-effect '> 
		<i class='material-icons'>picture_as_pdf</i> XI - Ganjil</a>";
				...
				if ($cek) {
					$cetak .= " <a   target='_blank' href='" . base_url() . "raport/cetak_raport?
			id=" . $dataDB->id . "&id_kelas=" . $id_kelas_2 . "&id_semester=2&id_tahun=" . $id_tahun_2 . "&id_tk=2' class='btn bg-blue waves-effect '> 
			<i class='material-icons'>picture_as_pdf</i> XI - Genap</a>";
				}
			}
			if ($id_kelas_3) {
				$cetak .= " <a   target='_blank' href='" . base_url() . "raport/cetak_raport?
		id=" . $dataDB->id . "&id_kelas=" . $id_kelas_3 . "&id_semester=1&id_tahun=" . $id_tahun_3 . "&id_tk=3' class='btn bg-orange waves-effect '> 
		<i class='material-icons'>picture_as_pdf</i> XII - Ganjil</a>";
				...
				if ($cek) {
					$cetak .= " <a   target='_blank' href='" . base_url() . "raport/cetak_raport?
			id=" . $dataDB->id . "&id_kelas=" . $id_kelas_3 . "&id_semester=2&id_tahun=" . $id_tahun_3 . "&id_tk=3' class='btn bg-deep-orange waves-effect '> 
		...
		foreach ($list as $dataDB) {
			...
			foreach ($data_p as $p) {
				...
				$prestasi .= "<p style='border-bottom:black solid 1px'><b><span class='col-blue'>[" . $p->nilai . "]</span> - " . $nama . "</b><br>" . $ket . " <span class='col-orange pull-right'>
				 <a class='cursor hide' href='javascript:edit(`" . $p->id . "`,`" . $dataDB->id . "`,`" . $p->id_ektra . "`,`" . $p->nilai . "`,`" . $p->ket . "`)'>Edit</a>   <a class='cursor hide' href='javascript:hapus(`" . $p->id . "`,`" . $nama . "`)'>Hapus</a> 
				  </span> <p>";
			}
