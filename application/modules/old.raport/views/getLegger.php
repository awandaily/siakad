...
-->
 ...
 <thead>
								...
								data-original-title='(nilai KI 70%+(UAS+UTS 30%) + Nilai KD 70+ (UAS+UTS 30%) + SIKAP )/3) ' data-toggle='tooltip'><center> RATA- RATA </center></th>
	  ...
	  dom: 'Blfrtip',
        ...
        "ajax": {
			...
			"data": function ( data ) {
						   ...
						   data.id_kelas ="<?php echo $this->m_reff->kelas_wali()?>";
						 // data.id_mapel_ajar =" ";
						 // data.id_mapel =" >";
