 ...
 ?>
						...
						<h2>DATA TENAGA PENDIDIK</h2>
                           ...
                           <div class="row clearfix">
								...
								<div class="col-md-3">
                                            ...
                                            <div class="form-line">
                                                  <select class="form-control show-tick" id="urutkan" onchange="reload_table()">
                                        <option value=""> Urut Abjad </option>
                                        <option value="1" selected>Paling Banyak Invalid</option>
                                        <option value="2">Paling Rajin</option>
                            ...
                            <div class="table-responsive">
                             <table id='tabel' class="tabel table-striped black table-bordered  table-hover dataTable">
								<thead  class='sadow bg-teal'  style="font-size:12px;width:100%" >			
									...
									<th class='thead' >JML JAM MASUK</th>
									<th class='thead' >JML JAM TIDAK MASUK</th>
									<th class='thead' >JML KELAS MENGAJAR</th>
									<th class='thead' >TOTAL KEWAJIBAN<br> MENGAJAR (Jam)</th>
									<th class='thead' >PROGRESS<br> MENGAJAR (Jam)</th>
   ...
   var  dataTable = $('#tabel').DataTable({ 
	  ...
	  dom: 'Blfrtip',
        ...
        "ajax": {
            "url": "<?php echo site_url('data_pendidik/data');?>",
            "type": "POST",
			"data": function ( data ) {
