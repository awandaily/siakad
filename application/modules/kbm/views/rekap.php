		...
		<div class=" d-flex right-page">
			<div class="d-flex justify-content-center mr-5">
				<div class="">
					...
					<span class="value">
					<select class="text-white border-white btn btn-outline-indigo btn-rounded btn-block form-control show-tick id_kelas<?php echo $token; ?>" id="fkelas" onchange="reload_table()">
