                        ...
                        <div class="row">
                        	<div class="col-md-12">
	                        	<div class="form-group">
	                        		...
	                        		<textarea name="" class="form-control" style="resize: none;height: 50px;" onchange="setKet(this.value, '<?php echo $res->code ?>')"><?php echo $nama_nilai;?></textarea>
	                        	</div>
	                        </div>
                        </div>
			...
			<div class="row row-sm">
						...
						<div class="col-xl-12 col-lg-6 col-md-6 col-sm-12">
							<div class="card overflow-hidden project-card">
								<div class="card-body">
									<div class="d-flex">
									<table class="table table-bordered mg-b-0" width="100%">
									<tr class="bg-blue">
										<th width="10px">NO</th>
										<th>NAMA SISWA</th>
										<?php
