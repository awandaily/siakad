                        ...
                        <table id='table' class="tabel black table-bordered  table-hover dataTable" style="font-size:12px;width:100%">
								...
								<tr>
								 <th class='bg-grey sadow' rowspan="2" width='15px'>&nbsp;NO</th>
									...
									<th   class='sadow bg-teal' align="center" colspan="<?php echo $jmlkikd+1;?>"><center>PENGETAHUAN (KD)</center></th>
									<th   class='sadow bg-primary' align="center" colspan="<?php echo $jmlkikd+1;?>"><center>KETERAMPILAN (KI)</center></th>
									
									<th rowspan="2"  class='sadow bg-pink' align="center"  ><center>UTS</center></th>
									<th rowspan="2"  class='sadow bg-pink' align="center"  ><center>UAS</center></th>
									<th colspan="3"  class='sadow bg-green' align="center"  ><center>NILAI BAHAN DIRAPORT</center></th>
								 ...
								 <tr>
									...
									foreach($datax->result() as $data)
								 	...
								 	<th class='bg-primary' 
									data-placement='top' data-original-title='Diambil dari nilai tertinggi' data-toggle='tooltip'
									>K </th>
								 	 </tr>
