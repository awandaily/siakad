<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
    Penjelasan:<br>
      1. Input data guru yang akan izin mengajar sampai jam pulang atau sampai berhari-hari.<br>
      2. Jika guru akan izin hanya untuk beberapa jam saja maka tidak diinput disini tapi diakun guru masing-masing.
    <div class="card">
...
<script>
    ...
    {
        $("#mdl_sbmt_izin_").modal("show");
    }
</script>

<div id="mdl_sbmt_izin_" class="modal fade" role="dialog">
  <div class="modal-dialog" id="area_sbmt">
    <div class="modal-content">
      ...
      <form method="POST" id="sbmt_izin_" action="javascript:submitForm('sbmt_izin_')" url="<?php echo base_url() ?>pd/insert_guru_izin">
      <div class="modal-body">
        
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        <label>Nama Guru (bisa pilih lebih dari 1)</label><br>
                        <select class="form-control show-tick fkelas" name="guru[]" data-live-search="true" multiple required="">
      ...
      <div class="modal-footer">
        <button class="btn pull-right bg-teal waves-effect" onclick="submitForm('sbmt_izin_')">SIMPAN</button>
      </div>
      </form>
    </div>
