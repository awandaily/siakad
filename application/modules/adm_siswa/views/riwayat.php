		...
		<div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  <div class="info-box hover-zoom-effect">
                        ...
                        <div class="content">
                            <div class="text"><b>TOTAL UANG PEMBAYARAN</b></div>
	...
	<div class="row clearfix" >	
						...
						<div class="table-responsive" id="area_lod">
                               <table id='table' class="tabel black table-bordered  table-hover dataTable" style="font-size:12px;width:100%">
								<thead  class='sadow bg-blue'>			
									<th class='thead' axis="string" width='10px'>&nbsp;NO</th>
	 ...
	 <script>
	  ...
	  dom: 'Blfrtip',
        ...
        "ajax": {
            "url": "<?php echo site_url('adm_siswa/getHistory');?>",
            "type": "POST",
			"data": function ( data ) {
...
function rincian(tgl,id_siswa)
{	loading();
	 
	  $("#mdl_rincian").modal();
    $.ajax({
	 url:link+"adm_siswa/getRincian",
     data:"tgl="+tgl+"&id_siswa="+id_siswa,
	 method:"POST",
     success: function(data)
            {
...
<script>
  function kelasLoad()
 {
	 ...
	 var id=$("#id_kelas").val();
	 $.post("<?php echo site_url("adm_siswa/getNamaSiswa"); ?>",{id:id},function(data){
		$("#getNama").html(data);
	 });
 }
    //Tooltip
