...
<div   class='garis'>
 ...
 <td align="left" style="table-layout:fixed;width: 45%;">  <b> 1 Gaji Pokok </b> </td>
 ...
 <td align="left" style="table-layout:fixed;width: 45%;">  <b> 2 Tunjangan Jabatan </b> </td>
 ...
 <td align="left" style="table-layout:fixed;width: 45%;">  <b> 7 Kepramukaan Wajib </b> </td>
 
 <td align="left" style="table-layout:fixed;width: 30%;">: Rp  <?php echo number_format($g=$db->kepramukaan_wajib,0,",",".");?>  </td>
 </tr> 
 <tr>
 
 <td align="left" style="table-layout:fixed;width: 45%;">  <b> 8 Supervisi Akademik </b> </td>
 ...
 <td align="left" style="table-layout:fixed;width: 45%;">  <b> 10 Honor Non KBM </b> </td>
 
 <td align="left" style="table-layout:fixed;width: 30%;">: Rp  <?php echo number_format($i=$db->honor,0,",",".");?> </td>
 </tr> <tr>
 
 <td align="left" style="table-layout:fixed;width: 45%;">  <b>Total </b> </td>
...
<td>: Rp <?php echo number_format($val->nominal,0,",",".") ?></td>
 ...
 <td align="left" style="table-layout:fixed;width: 45%;">&nbsp;<?php echo $i ?>. Potongan Pinjaman  </td>
 ...
 <td align="left" style="table-layout:fixed;width: 45%;" align='left'>&nbsp;<b>Total</b> </td>
 ...
 <table       border="0"  cellspacing="0"  >
  <tr>
  <td align="left" style="table-layout:fixed;width: 59%;" align="right">&nbsp; JUMLAH PEMASUKAN  </td>
 ...
 <td align="right" style="table-layout:fixed;width:20%;" align="right">     <?php echo number_format($db->jml_pemasukan,0,",",".");?>  </td>
  ...
  <td align="left" style="table-layout:fixed;width: 59%;" align="right">&nbsp; JUMLAH POTONGAN </td>   <td style="table-layout:fixed;width: 20%;" align="right">Rp</td>
 <td align="right" style="table-layout:fixed;width: 20%;" align="right">     <?php echo number_format($db->jml_potongan,0,",",".");?>  </td>
 </tr><tr>
  <td align="left" style="table-layout:fixed;width: 59%;" align="right">&nbsp;<b>TOTAL PEMBAYARAN</b> </td>   <td style="table-layout:fixed;width: 20%;" align="right">Rp</td>
...
<td style="table-layout:fixed;width: 30%;" valign="bottom" align="right">
  <div align="center" class="bendahara"  >
     <br>
  Penerima, <br>
 <br>
