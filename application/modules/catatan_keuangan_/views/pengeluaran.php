...
<div class="row clearfix" style="margin-top:-20px">
   ...
   function getAkun()
   {
	   ...
	   $.post("<?php echo site_url("catatan_keuangan/getDataFilter"); ?>",{tipe:tipe},function(data){
		$("#dataFkode").html(data);	
		loadTable();
	 }); 
    ...
    {	var grafik=$("[name='grafik']").val();
        ...
        $.ajax({
            ...
            type: "POST",
            data: {grafik:grafik,tanggal:tanggal,tipe:tipe,kode:kode},
...
function edit_data(id,nama,nominal,tgl,ket)
{
	...
	$.post("<?php echo site_url("catatan_keuangan/getEditPengeluaran"); ?>",{id:id},function(data){
