 <?php $token=date("His");?>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="header">
                         <div class="col-md-3"  >    
					<div class="demo-google-material-icon col-teal"> <i class="material-icons">thumb_up</i>
					<span class="icon-name" style="position:absolute;margin-top:3px;margin-left:5px"><b> Catatan Baik</b></span> </div>
