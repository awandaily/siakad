 <?php $token=date("His");?>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="header">
                         <div class="col-md-3"  >    
					<div class="demo-google-material-icon col-red"> <i class="material-icons">thumb_down</i>
					<span class="icon-name" style="position:absolute;margin-top:1px;margin-left:5px"><b> Catatan Buruk</b></span> </div>
 ...
 $('select').selectpicker();
  ...
  <script type="text/javascript">
  	  function hapus(id,akun){
		   ...
		   $.post("<?php echo site_url("catatan_anak/hapus_catatan"); ?>",{id:id},function(){
			   reload_table();
		      })
		   })
	  };
