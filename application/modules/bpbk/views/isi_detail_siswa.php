                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li role="presentation" >
                                    <a href="#absensi" data-toggle="tab" class="sound"  >
                                        <i class="material-icons">fingerprint</i>   KETIDAKHADIRAN PERPERTEMUAN 
                                    </a>
                                </li>
									  ...
									  $sms=$this->m_reff->semester();
										   ...
										   where id_tahun='".$tahun."' and id_semester='".$sms."' ")->result();
											foreach($dt as $val)
											{
												...
												foreach($db as $vals)
												{
													echo '<td  align="center"><center>  '.$this->mdl->kehadiran($data->id,$vals->id,$val->bln).'</center></td>';
												}
												echo "</tr>";
											}												
										 ?>
                      ...
                      <div class="table-responsive">
                        <div class="body entry">
                             ...
                             <table class="entry table-hover" width="100%">
									...
									<?php
									/*$no=1;
									foreach($this->mdl->getTagihan($data->nis) as $dataDB)
									{?>
									<tr>
									<td><?php echo $no++;?></td>
									<td><?php echo $dataDB->nama_tagihan;?></td>
									<td><?php echo number_format($dataDB->nominal,0,",",".");?></td>
									<td><?php echo number_format($t=$this->mdl->telahDibayar($dataDB->id),0,",",".");?></td>
