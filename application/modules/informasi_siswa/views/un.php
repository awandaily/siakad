                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="card" >
                        <div class="header"> 
                         ...
                         <button    onclick="import_data()" class="btn bg-teal waves-effect"><i class="material-icons">file_download</i>IMPORT STATUS UJIAN</button>
                       
                         </div>
                        
						 <div class="btn-group pull-right" role="group" id="ekse">
                         <button    onclick="eksekusi(1)" class="btn bg-green waves-effect"> LULUS</button>
                         <button onclick="eksekusi(2)" class="  waves-effect btn bg-pink">  TIDAK LULUS </button>
                         <button onclick="eksekusi(3)" class="pull-right waves-effect btn bg-blue-grey">  TIDAK DITAMPILKAN </button>
                         </div>
			            ...
			            <div cass="body" >
                            <div class="table-responsive">
                             <table id='tabel' class="tabel table-striped black table-bordered  table-hover dataTable"  style="font-size:12px;width:100%" >
								...
								<th class='thead'  style="max-width:22px">
									...
									<th class='thead' style='max-width:3px'>NO</th> 
										<th class='thead' style='min-width:125px'   >KELAS</th>
									<th class='thead' style='min-width:125px'   >NAMA</th>
										<th class='thead' >NO.UJIAN</th>  
	 ...
	 function get_value_uncheck()
  {
   ...
   var  dataTable = $('#tabel').DataTable({ 
	  ...
	  dom: 'Blfrtip',
        ...
        "ajax": {
            "url": "<?php echo site_url('informasi_siswa/data_siswa');?>",
            "type": "POST",
			"data": function ( data ) {
