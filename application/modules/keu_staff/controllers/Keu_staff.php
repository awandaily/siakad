...
class Keu_staff extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->m_konfig->validasi_session(array("keuangan", "keuangan pegawai", "kepsek"));
	...
	public function pinjaman()
	{
		...
		$this->m_konfig->validasi_session(array("keuangan", "koperasi", "keuangan pegawai", "kepsek"));
		$ajax = $this->input->get_post("ajax");
		if ($ajax == "yes") {
	...
	{
		$this->m_konfig->validasi_session(array("keuangan", "koperasi", "kepsek"));
		$ajax = $this->input->get_post("ajax");
		if ($ajax == "yes") {
	...
	{
		$this->m_konfig->validasi_session(array("keuangan", "kepsek"));
