<div  id="lod_rincian" style="margin-top:-10px;min-height:120px">
									   ...
									   foreach($db as $db){
										   ...
										   if($sisa==0)//LUNAS
										   {
											   ...
											   if($db->sts==1){
												   ...
												   $telah_bayar=$db->bayar;
											   		...
											   		$byr=$this->tanggal->hariLengkap($db->tgl_bayar,"/");
										   ...
										   { 	$sisa=number_format($sisa,0,",",".");
											   ...
											   if(!$byr){ 
											   		$byr=$this->tanggal->hariLengkap($db->tgl_bayar,"/");  
											   		$tombol='<span class="col-black">'.$byr.' 
									   ...
									   <td>".$nama_satuan." <br> <i class='col-indigo'> Tgl tagihan:".$this->tanggal->ind($db->tgl_tagihan,"/")."</i></td><td>   ".number_format($tagihan,0,",",".")." </td>
