		...
		<div class="row clearfix">
                <div class="hide col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  <div class="info-box hover-zoom-effect">
                        ...
                        <div class="content">
                            <div class="text">TOTAL UANG PEMBAYARAN</div>
	...
	<div class="row clearfix" >	
                    ...
                    <div class="card" id="blockarea"  >
						...
						<!--		<div class="col-sm-6" id="bulan">
							...
							//		  $awal=$this->tanggal->ind($awal,"/");
									   ...
									   ?>--->
								 <input value="" id="ftanggal<?php echo $token?>" readonly class="cursor form-control col-md-12 " type="hidden" >
                    ...
                    <!--    </div>-->
							...
							<div class="col-sm-3 pull-right">
                                ...
                                <div class="col-sm-9 pull-right">
								 	    <h4>DATA  RINCIAN PEMBAYARAN <?php echo $label_tk ?></h4>
								 	    </div>	 
	 ...
	 <script>
			 ...
			 
	  {
        ...
        "ajax": {
            "url": "<?php echo site_url('datasi/getHistoryDetail');?>",
            "type": "POST",
			"data": function ( data ) {
