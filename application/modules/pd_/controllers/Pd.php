...
class Pd extends CI_Controller
{
	...
	function getDataguru()
	{
		...
		foreach ($list as $dataDB) {
			...
			$row = array();
			$row[] =  '
			 <input type="checkbox" id="md_checkbox_' . $dataDB->id_guru . '"   class="pilih filled-in chk-col-red" onclick="pilcek()"  name="kelas[]"  value="' . $dataDB->id_guru . '" />
                                <label for="md_checkbox_' . $dataDB->id_guru . '">&nbsp;</label> ';
