...
<table class="tborder" width="100%" cellspacing="0" border="1">
    ...
    <tr>
        <th class='bg-teal sadow' style='background-color:#009688;color:white;font-weight:bold' rowspan="3" width='24px'>&nbsp;NO</th>
    ...
    <?php echo "<td>" . strtoupper($val->jk) . "</td>";
        ...
        foreach ($mapel->result() as $value) {
            ...
            if ($value->mapel_global == 2 and $agama > 1) {
                ...
                if ($value->k_mapel == "A") {
                    ...
                    $ns = $this->mdl->getNsNonMuslim($val->id);
                    $n2 = $this->mdl->getNpNonMuslim($val->id);
                    $n3 = $this->mdl->getNkNonMuslim($val->id);

                    echo "<td><i class='col-indigo' title='non-muslim' style='color:blue'><b>" . $ns . "</b></i></td>";

                    echo "<td><i class='col-indigo' title='non-muslim'  style='color:blue'><b>" . $n2 . "</b></i></td>";

                    echo "<td><i class='col-indigo' title='non-muslim'  style='color:blue'><b>" . $n3 . "</b></i></td>";
                ...
                $ns = $this->mdl->getNilaiRataSikap($val->id, $value->id_mapel, $sms);
        ...
        $jumlah = (($nilaiSikap + $a[$val->id][0]
            ...
            $nilaiKeterampilan + $a[$val->id][2]) / 3);
