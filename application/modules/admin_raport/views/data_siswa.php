    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="card">
            <div class="header">
                ...
                <a target="_blank" href="<?php echo base_url() ?>raport/download_legger?kelas=<?php echo $idkelas ?>" class="waves-effect btn bg-teal btn-block">
                    <i class="material-icons">format_indent_increase</i>
                    DOWNLOAD LEGGER</a>
            </div>
            <!-- <button type="submit" class="btn btn-success pull-right" style=" margin-bottom: 25px" onclick="cetakLagger()">Cetak Lagger</button> -->
                    ...
                    <div class="table-responsive">
                        <table id='tabel' class="tabel table-striped black table-bordered  table-hover dataTable" style="font-size:12px;width:100%">
                            <thead class='sadow bg-teal'>
                                ...
                                <th class='thead' style='min-width:45px'>NIS</th>
                                <th class='thead'>RAPORT</th>
                            </thead>
                        </table>
                    </div>
                </div>
...
<script type="text/javascript">
    var dataTable = $('#tabel').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('admin_raport/getDataSiswa_cetak'); ?>",
            "type": "POST",
            "data": function(data) {
    ...
    function setNilai(id_siswa) {
        ...
        $.post("<?php echo site_url("raport/update_catatan"); ?>", {
            ket: ket,
            id_siswa: id_siswa
        }, function() {
...
<script>
    function cetakLagger() {
        console.log("masuk cetakLagger")
        var idkelas = $("#fkelas").val();
        $.post("<?php echo site_url("admin_raport/dataLegger"); ?>", {
            idkelas: idkelas
