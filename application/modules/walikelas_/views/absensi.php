                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="header row">
                         <div class="col-md-12" >     <h2 style='font-size:16px'><b>Ketidak hadiran Siswa Per-Pertemuan Bukan Perhari</b></h2> </div>
 ...
 <div class="modal fade" id="mdl_modal" tabindex="-1" role="dialog">
	...
	<form  action="javascript:submitForm('modal_artikel')" id="modal_artikel" url="#"   method="post" enctype="multipart/form-data">
				...
				<script>
 function cekAbsen(id,title,absen)
 {		$(".titles").html(title);
	 	 loading();
	  $.post("<?php echo site_url("walikelas/cekAbsen"); ?>",{id:id,kriteria:absen},function(data){
 ...
 $('select').selectpicker();
  ...
  var  dataTable = $('#table').DataTable({ 
	  ...
	  dom: 'Blfrtip',
        ...
        "ajax": {
            "url": "<?php echo site_url('walikelas/getAbsen');?>",
            "type": "POST",
			"data": function ( data ) {
