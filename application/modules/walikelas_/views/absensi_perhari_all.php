                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="header row">
	                        <div class="col-md-8" >
	                         	<h2 style='font-size:16px'><b>Ketidakhadiran Seluruh Siswa Perhari</b></h2> 
	                        </div>
                         	<div class="col-md-4 col-sm-4">
                            	<select class="form-control show-tick" id="f_kelas" data-live-search="true"  onchange="reload_table();">
 ...
 {		$(".titles").html(title);
	 	 loading();
	  $.post("<?php echo site_url("walikelas/cekAbsenPerhari"); ?>",{id:id,kriteria:absen},function(data){
 ...
 $('select').selectpicker();
  ...
  var  dataTable = $('#table').DataTable({ 
	  ...
	  dom: 'Blfrtip',
        ...
        "ajax": {
            "url": "<?php echo site_url('walikelas/getAbsenPerhariAll');?>",
            "type": "POST",
			"data": function ( data ) {
			  data.id_kelas= $('#f_kelas').val(); 
