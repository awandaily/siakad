    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
	 	<div class="card" >
            <div class="header" style="padding: 10px;">
            	<div class="row">
                    <div class="col-sm-3">
                        <h2 style="padding-top: 10px;">DATA PETUGAS PERPUS</h2>
                    </div>
                    <div class="col-sm-9">
...
<div id="mdl_fadd" class="modal fade" role="dialog">
    <div class="modal-dialog" id="area_fadd">
        <div class="modal-content">
            <form id="fadd" action="javascript:submitForm('fadd')" method="post" url="<?php echo base_url() ?>master/save_petugas">
...
<script type="text/javascript">
    ...
    function add(){
        ...
        $.post("<?php echo base_url() ?>master/petugas_form", {id:id}, function(data){
            $("#md-add-title").html("TAMBAH DATA PETUGAS");
            $("#mdl_fadd").modal("show");
    ...
    function hapus(id, nm){
        alertify.confirm("<center>Apakaha anda yakin akan menghapus data <strong>"+nm+"</strong> </center>", function() {
            $.post("<?php echo base_url()?>master/delete_petugas", {id: id}, function() {
                reload_table();
            })
        })
    }
    ...
    var  dataTable = $('#table').DataTable({ 
        ...
        "lengthMenu":
            ...
            [10 , 30,50,100,200,300,400,500]], 
        "ajax": {
            "url": "<?php echo site_url('master/data_petugas');?>",
            "type": "POST",
            "data": function ( data ) {         
