...
<div class="col-md-12">&nbsp;</div>
  ...
  <script type="text/javascript">
  	  function hapus(id,artikel){
		   ...
		   $.post("<?php echo site_url("website/hapus"); ?>",{id:id},function(){
			   reload_table();
		      })
		   })
	  };
   ...
   // $(document).ready(function() {
      table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('website/data');?>",
            "type": "POST",
...
function add()
{
 ...
 <div class="modal fade" id="modal_artikel" tabindex="-1" role="dialog">
	...
	<form  action="javascript:saveModalArtikel('modal_artikel')" id="f_modal_artikel" url="<?php echo base_url()?>website/save_artikel"  class="form-horizontal" method="post" enctype="multipart/form-data">
...
$("#imgInp").change(function() {
 ...
 <div class="modal fade" id="modal_artikel_edit" tabindex="-1" role="dialog">
				...
				<form  action="javascript:saveModalArtikelUpdate('modal_artikel_update')" id="f_modal_artikel_update" url="<?php echo base_url()?>website/update_artikel"  class="form-horizontal" method="post" enctype="multipart/form-data">
                    <div class="modal-content"> <span  title="tutup"  data-dismiss="modal" class="    pull-right waves-effect"><i class="material-icons">cancel</i> </span>
                        <div class="modal-header">
                            <h4 class="modal-title" id="defaultModalLabel">Post Artikel Baru </h4>
