...
class Kirim_tugas extends CI_Controller
{
	...
	{
		parent::__construct();
		$this->m_konfig->validasi_session(array("GURU", "KEPSEK", "ADMIN"));
	...
	function getPengumuman()
	{
		...
		foreach ($list as $dataDB) {
            ...
            <div class="btn-group btn-group-justified" role="group" aria-label="Justified button group">
                                <a href="javascript:edit(`' . $dataDB->id . '`,`' . $dataDB->judul . '`)" class="btn bg-grey waves-effect" role="button" style="' . $edit . '">EDIT</a>
                                <a href="javascript:hapus(`' . $dataDB->id . '`,`' . $dataDB->judul . '`)" class="btn bg-blue-grey waves-effect" role="button">HAPUS</a>
