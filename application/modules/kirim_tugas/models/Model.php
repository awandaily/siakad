...
class Model extends CI_Model  {
	...
	function insert_pengumuman()
	{
		...
		if(!file_exists($path)){
			...
			{
        		$do=$this->m_reff->upload_file("file","pengumuman",$nama_file_awal="info",$type_file_yg_diizinkan="JPG,JPEG,PNG,XLSX,DOCX,PDF,pptx,ZIP,zip,rar,RAR",$sizeFile="5000000",$before_file=null);
        		if($do["size"]==false){
        		  //  $max=$do["maxsize"]."MB";
        		      $do["gagal"]=false; $do["info"]="File terlalu besar maksimal 5MB";
        		      return $do;
        		}
