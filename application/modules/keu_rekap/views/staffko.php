...
<!--							<div class="col-sm-2">	
                            ...
                            <div class="table-responsive">
                             <table id='tabel' class="tabel table-striped black table-bordered  table-hover dataTable"  style="font-size:12px;width:100%" >
								<thead  class='sadow bg-teal' >			
									...
									<th class='thead' style='min-width:115px' >SISA HUTANG PINJAMAN</th>
   ...
   var  dataTable = $('#tabel').DataTable({ 
	  ...
	  dom: 'Blfrtip',
        ...
        "ajax": {
            "url": "<?php echo site_url('keu_rekap/getDataGuruKo');?>",
            "type": "POST",
			"data": function ( data ) {
                       ...
                       <span class="sr-only">Close</span>
                        ...
                        <div class="modal-body">
							...
							<input name="id"   type="hidden">
								...
								<div class="row clearfix">
                                    <div class="col-lg-3 col-md-3  form-control-label">
                                        <label for="email_address_2" class="col-black">Penambahan Fungsional</label>
                                    </div>
                                    <div class="col-lg-8 col-md-8  ">
                                        <div class="form-group">
                                            <div class="form-line" id="data_mapel">
