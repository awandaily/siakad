		 ...
		 success: function(data)
				{ 	  unblock("area_"+id); 	
				   reload_table();
					...
					{	  
							notif("<b>Gagal !! Terdapat KD/KI yang sudah pernah diinput.</b>");
					...
					}else if(data["format_kd3_kutif"]==false)
					{	  
							notif("<b>Gagal !! Penulisan   No.KD harus menggunakan petik diawal.</b>");
					}else if(data["format_kd4_kutif"]==false)
					{	  
							notif("<b>Gagal !! Penulisan   No.KI harus menggunakan petik diawal.</b>");
					}else if(data["tidaksama"]==false)
					{	  
							notif("<b>Gagal !!Terdapat penulisan   No.KD dan No.KI tidak sama.</b>");
					}else
					{	  
